...
protected static Logger logger = Logger.getLogger(StartupServiceImpl.class);
...
@Override
public void deleteBean(Startup startup) {
	logger.debug("Inside method StartupServiceImpl.deleteBean, delete bean : " + startup);
	/*talent.setStatus("active");
talent.setCreationTime(new Date());*/
	basicDAO.deleteBean(startup);
	logger.debug("Inside method StartupServiceImpl.deleteBean, after deleting bean");
